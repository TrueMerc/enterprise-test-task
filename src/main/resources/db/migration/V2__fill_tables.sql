...
INSERT INTO employees (second_name, first_name, patronymic, work_hours_id, age)
    VALUES ('Ivanov', 'Ivan', 'Ivanovich', 1, 25),
           ('Petrov', 'Petr', 'Petrovich', 2, 34),
           ('Sidorov', 'Petr', 'Grigorievich', 3, 38),
           ('Smirnov', 'Ivan', 'Ivanovich', 1, 27),
           ('Kuznetsov', 'Vladimir', 'Nikolaevich', 3, 35),
           ('Nikolaev', 'Ivan', 'Petrovich', 2, 30),
           ('Ivanov', 'Petr', 'Vladimirovich', 2, 29),
           ('Smirnov', 'Vladimir', 'Ivanovich', 3, 29),
           ('Sidorov', 'Nikolay', 'Petrovich', 1, 31);
